...
namespace OnlineReg
{
    public partial class NotPaidReport : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (_member != null)
            {
                ...
                {
                    PaidRepeater.DataSource = DBCommon.NotGetMembersPaid();
        ...
        {
            DBCommon.ExportTableData(DBCommon.ToDataTable<vNotMemberPaid>(DBCommon.NotGetMembersPaid()), "NotMembersPaidReport", Response);
