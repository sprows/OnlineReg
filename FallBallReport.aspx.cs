...
namespace OnlineReg
{
    public partial class FallBallReport : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (_member != null)
            {
                ...
                {
                    PlayerRepeater.DataSource = DBCommon.GetFallBallView();
        ...
        protected void ExportButton_Click(object sender, EventArgs e)
        {
            ...
            DBCommon.ExportTableData(DBCommon.ToDataTable<vFallBall>(DBCommon.GetFallBallView()), "FallBallReport", Response);
